...
class Driver extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['created_on', 'modified_on', 'accepted_on', 'admin_id_accepted', 'role', 'driver_rank', 'folder_image', 'avatar', 'status', 'certificate_type', 'activity_area', 'referral_code', 'point', 'reason', 'english', 'parent_id', 'is_sub_driver', 'driver_license_front', 'driver_license_behind', 'allow_notification', 'identity_back_image', 'identity_front_image', 'email'], 'safe'],
            [['username', 'password', 'display_name', 'money'], 'required'],
