        ...
        if (isset($tripList) && is_array($tripList) && count($tripList)) {
            foreach ($tripList as $tripItem) {
                ...
                <tr data-key="<?= $tripItem->id ?>" role="row">
                    ...
                    $html .= '
                        <td class="text-center">
                            <span class="js-driver_debt_collection text-bold ' . ($tripItem->driver_debt == 0 ? 'text-danger' : 'text-info collected') . '" data-id="' . $tripItem->id . '" id="collected-money-' . $tripItem->id . '" style= "cursor: pointer;">
                                ' . ($tripItem->driver_debt == 0 ? 'Nợ' : 'Đã thu') .
                        '</span>
                        </td>';
                    echo $html; ?>
