...
$this->title = 'Danh sách tài xế đang nợ';
$this->params['breadcrumbs'][] = $this->title;

// include js
$this->registerJsFile('/js/pages/trip-driver-debt-collection.js', ['depends' => [YiiAsset::class]]);
...
<div class="trip-index">
  ...
  ?>
    ...
    <div class="table-view-list js-ajax-table">
        ...
        echo $this->render('table-driver-debt-collection', compact(['searchModel', 'tripList', 'tripModel', 'dataProvider']));
        ?>
    </div>
</div>
