...
use yii\helpers\Html;
        ...
        $agencyTotalPrice = 0;
        // Check if the agency list is not empty, is an array, and contains items
                ...
                <tr data-key="<?= $agencyId ?>" role="row" class="tr-agency-debt">
                    ...
                    <td class="text-center">
                        <div class="d-flex" style="justify-content: center; flex-wrap: wrap;">
                            <button type="button" class="js-btn-trip-agency btn-primary btn mb2" title="Thanh toán" style="margin-right: 10px" data-id="<?= $agencyId ?>"><span>Thanh toán</span></button>
                            <?php
