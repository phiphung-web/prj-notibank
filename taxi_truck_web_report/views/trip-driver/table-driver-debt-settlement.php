...
<table id="datatables_w0" class="table table-striped table-bordered js-ajax-table" width="100%" cellspacing="0"
    ...
    <thead>
        <tr>
            ...
            <th>Khách hàng</th>
            <th>Lái xe</th>
            <th class="text-center text-nowrap">Lái xe nhận</th>
            <th class="text-center text-nowrap">Trạng thái</th>
            <th class="text-center text-nowrap">Nguồn</th>
            <th class="text-center text-nowrap">Trạng thái nợ</th>
            <th></th>
        </tr>
    </thead>
    <tbody>
            ...
            foreach ($tripList as $tripItem) {
                ...
                <tr data-key="<?= $tripItem->id ?>" role="row">
                    ...
                    <td>
                        ...
                        <?php } ?>
                        <div class="text-nowrap">Thu khách: <span class="text-danger text-bold">
                    ...
                    $html .= '
                        <td class="text-center">
                            <span class="js-driver_debt_settlement text-bold ' . ($tripItem->driver_debt == 0 ? 'text-danger' : 'text-info collected') . '" data-id="' . $tripItem->id . '" id="collected-money-' . $tripItem->id . '" style= "cursor: pointer;">
                                ' . ($tripItem->driver_debt == 0 ? 'Nợ' : 'Đã trả') .
                        '</span>
                        </td>';
                    echo $html; ?>
